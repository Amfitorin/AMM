...
type
  ...
  tree_node = record
     ...
     //element: Real; // Вещественное значение
...
function ParentCount(v: tree_ptr): Integer; // 17) Рекурсивная функция подсчета количества наследников у узла 
function SumLR(v: tree_ptr): Integer; // 18) Функция поиска и суммирования ключей
function CountLR(v: tree_ptr): Integer; // 19) Функция поиска и суммирования количества узлов
...
// 17) Рекурсивная функция подсчета количества наследников у узла
...
// 18) Функция поиска и суммирования ключей тех узлов, у которых количество
...
// 19) Функция поиска и суммирования количества узлов, у которых количество
// потомков в левом поддереве отличается от количества потомков в правом
// поддереве на 1
